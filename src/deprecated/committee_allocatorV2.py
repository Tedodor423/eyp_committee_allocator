...
# load info
if prefilled: input_filename = "11th Regional Selection Conference of EYP CZ Hradec Králové 2022 Delegates All-in-One Form(1-61).xlsx"
else:
...
# GENERATE ALL POSSIBLE COMMITTEES
for bigger_committees in com
    for committee_name in committees:
        ...
        for candidate_index in reversed(candidates):  # reversed to avoid eating our own tail when deleting in list
            committees[committee_name].append((names[candidate_index], schools[candidate_index]))
